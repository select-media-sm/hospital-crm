...
export default function Dashboard({ data, onNavigate }) {
  ...
  return (
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(210px, calc(50% - 10px)), 1fr))", gap: 14, marginBottom: 14 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(210px, calc(50% - 10px)), 1fr))", gap: 14, marginBottom: 26 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(400px, 100%), 1fr))", gap: 16, marginBottom: 16 }}>
