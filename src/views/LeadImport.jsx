...
export default function LeadImport({ data, setData }) {
  ...
  const doImport = () => {
    ...
    newRows.forEach((r) => {
      ...
      leads.push({ id: uid(), name: r.name, mobile: r.mobile, source: r.source || "Import", department: r.department, doctor: r.doctor, stage, patientId: "", nextFollowup: "", createdAt: r.date || todayISO() });
    });
