        ...
        <div>
          ...
          <Card style={{ padding: 0 }}>
            {consultBills.map((b, i) => {
              ...
              return (
                <div key={b.id} style={{ display: "grid", gridTemplateColumns: "0.9fr 1.2fr 1fr 0.9fr 0.9fr 0.9fr auto auto", gap: 10, alignItems: "center", padding: "13px 20px", borderTop: i ? `1px solid ${COLORS.line}` : "none" }}>
                  ...
                  {b.status !== "Paid" && <Btn small icon={CheckCircle2} onClick={() => markConsultPaid(b.id)}>Mark paid</Btn>}
